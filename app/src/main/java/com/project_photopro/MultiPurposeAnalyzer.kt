...
class MultiPurposeAnalyzer(private val activity: MainActivity, private val rotation: Int) : ImageAnalysis.Analyzer {
    ...
    private val preferences: SharedPreferences = activity.getSharedPreferences(
        SharedPrefs.SHARED_PREFERENCES_KEY,
        ...
        object : CountDownTimer(1000, 1000) {
            ...
            override fun onFinish() {
                ...
                if (preferences.getInt(
                        SharedPrefs.NIGHT_MODE_KEY,
                        Constant.NIGHT_MODE_OFF
                    ) != Constant.NIGHT_MODE_AUTO
                ) {
                    return
                }
    ...
    private fun frameAvg() {
        ...
        if (frameAvgResult == null) {
            ...
            frameAvgResult =
                Mat(Size(currentFrame.width().toDouble(), currentFrame.height().toDouble()), currentFrame.type())
        }

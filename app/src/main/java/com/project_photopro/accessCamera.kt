...
fun startCamera(
    ...
    // Created outside cameraProviderFuture listener to be able to return the analyzer and change values (smart delay and frame avg)
